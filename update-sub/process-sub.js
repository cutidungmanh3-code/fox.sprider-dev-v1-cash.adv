...
async function main() {
    ...
    if (!subUrl) {
        console.error("❌ SUB_URL chưa được thiết lập!");
        process.exit(1);
    }
    ...
    try {
        ...
        // Decode Base64 nếu subscription là base64
        if (!content.includes('://')) {
        ...
        // Danh sách tag thừa cần xóa
        const junkRegex = [
            /\|BGP\|流媒体/g, /\|流媒体/g, /\|BGP\|CTCU/g,
            /\|BGP\|CUCM/g, /\|CTCU/g, /\|CUCM/g,
            /\|Relay/g, /\|Backup/g, /\|Test/g, /\|0\.1x/g
        ];
